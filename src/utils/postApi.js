...
export function create(data){
	return fetch(BASE_URL, {
		...
		if(responseFromTheServer.ok) return responseFromTheServer.json() // so if everything went well in the response return the parsed json to where we called the function
